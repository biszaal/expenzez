...
import { COLORS, cardRoot, paletteFor, flameTier } from "./theme";
    ...
    <FlexWidget clickAction="OPEN_URI" clickActionData={{ uri: DEEP_LINK }} style={cardRoot(p)}>
      ...
      >
        ...
        {best > 0 ? (
          <TextWidget
            text={`Best ${best}`}
            style={{ fontSize: 11, color: p.textMuted, fontWeight: "600" }}
          />
        ) : null}
      </FlexWidget>
      <FlexWidget style={{ flexDirection: "row", alignItems: "flex-end", marginTop: 4 }}>
        ...
        <TextWidget
          text={` ${streak.current}`}
          style={{ fontSize: 36, color: p.text, fontWeight: "700" }}
        />
        <TextWidget
          text={streak.current === 1 ? " day" : " days"}
          style={{ fontSize: 13, color: p.textMuted, fontWeight: "500", marginBottom: 7 }}
        />
      </FlexWidget>
      {streak.current === 0 ? (
        <TextWidget
      ...
      >
        ...
        <TextWidget
          ...
          style={{ fontSize: 11, color: p.textMuted, fontWeight: "500" }}
        />
      </FlexWidget>
