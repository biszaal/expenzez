                ...
                {dailySpendingData && dailySpendingData.data.length > 0 && (
                  <View style={styles.miniStatsContainer}>
                    ...
                    <View style={[styles.miniStatCard, { backgroundColor: colors.background.secondary }]}>
                      <View style={[styles.miniStatIcon, { backgroundColor: colors.primary[100] }]}>
                    ...
                    {/* Daily Average Card */}
                    <View style={[styles.miniStatCard, { backgroundColor: colors.background.secondary }]}>
                      <View style={[styles.miniStatIcon, { backgroundColor: colors.success[100] }]}>
                        <Ionicons name="bar-chart-outline" size={16} color={colors.success[500]} />
                      </View>
                      <View style={styles.miniStatContent}>
                        <Text style={[styles.miniStatValue, { color: colors.text.primary }]}>
                          £{(dailySpendingData.data.reduce((a, b) => a + b, 0) / dailySpendingData.data.filter(v => v > 0).length).toFixed(0)}
                        </Text>
                        <Text style={[styles.miniStatLabel, { color: colors.text.secondary }]}>
                          Daily Avg
                        </Text>
                    ...
                    {/* vs Last Month Card */}
                    {dailySpendingData.prevMonthData && dailySpendingData.prevMonthData.some(v => v > 0) && (() => {
                      const thisMonthTotal = dailySpendingData.data.reduce((a, b) => a + b, 0);
                      const lastMonthTotal = dailySpendingData.prevMonthData.reduce((a, b) => a + b, 0);
                      ...
                      return (
                        <View style={[styles.miniStatCard, { backgroundColor: colors.background.secondary }]}>
                          <View style={[styles.miniStatIcon, { backgroundColor: isIncrease ? colors.error[100] : colors.success[100] }]}>
                            <Ionicons
                              name={isIncrease ? "arrow-up" : "arrow-down"}
                              size={16}
                              color={isIncrease ? colors.error[500] : colors.success[500]}
                            />
                          </View>
                          <View style={styles.miniStatContent}>
                            <Text style={[styles.miniStatValue, { color: isIncrease ? colors.error[500] : colors.success[500] }]}>
