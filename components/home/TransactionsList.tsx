    ...
    >
      <View style={styles.premiumTransactionsHeader}>
        <View style={styles.premiumTransactionsHeaderLeft}>
          ...
          <View style={styles.premiumTransactionsHeaderText}>
            <Text
              style={[
                styles.premiumTransactionsTitle,
            ...
            <Text
              style={[
                styles.premiumTransactionsSubtitle,
        ...
        {transactions.slice(0, 4).map((tx, idx) => (
          ...
          >
            ...
            <View style={styles.premiumTransactionContent}>
              <Text
                style={[
                  styles.premiumTransactionTitle,
                  { color: colors.text.primary },
                ]}
                numberOfLines={1}
              >
      ...
      {transactions.length === 0 && (
        <View style={styles.premiumEmptyState}>
          ...
          <Text
            style={[styles.premiumEmptyTitle, { color: colors.text.primary }]}
          >
            No transactions yet
          </Text>
          <Text
            style={[
              styles.premiumEmptySubtitle,
              { color: colors.text.secondary },
            ]}
          >
      ...
      >
        <Text style={styles.premiumViewAllTransactionsText}>
