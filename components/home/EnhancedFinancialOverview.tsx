...
export const EnhancedFinancialOverview: React.FC<EnhancedFinancialOverviewProps> = ({
  thisMonthSpent,
  userBudget,
}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.overviewCard, { backgroundColor: colors.background.secondary }]}>
        <View style={styles.statsContainer}>
          ...
          <View style={styles.statSection}>
            <View style={styles.statHeader}>
              ...
              <View style={[styles.statBadge, { backgroundColor: isOverBudget ? '#EF4444' : '#10B981' }]}>
                <Ionicons 
        ...
        {/* Summary Section */}
        <View style={[styles.summarySection, { backgroundColor: colors.background.primary }]}>
