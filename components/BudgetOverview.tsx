      ...
      <View style={[styles.container, { backgroundColor: colors.background.secondary }]}>
        ...
        <View style={styles.emptyState}>
          ...
          <TouchableOpacity
            ...
            style={[styles.createButton, { backgroundColor: colors.primary[100] }]}
          >
            <Text style={[styles.createButtonText, { color: colors.primary[600] }]}>
              Create Budget
            </Text>
          </TouchableOpacity>
        </View>
        ...
        {budgetProgress.map((progress) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={[styles.budgetItem, { backgroundColor: colors.background.primary }]}
